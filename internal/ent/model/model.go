...
// Title is a journal or a book that contains items. Title instances are
// transient and are stored in a database together with Item's data.
type Title struct {
