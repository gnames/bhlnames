...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/bhl.RefsByName"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/bhl.Reference"
                        }
                    }
                }
            }
        },
        "/taxon_items/{taxon_name}": {
            "get": {
                "consumes": [
                    "text/plain"
                ],
                ...
                "operationId": "get-items-by-taxon",
                "parameters": [
                    {
                        "type": "string",
                        "example": "\"Lepidoptera\"",
                ...
                "responses": {
                    "200": {
                        "description": "BHL items with metadata and statistics",
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/bhl.Item"
    ...
    "definitions": {
        ...
        "bhl.ReferenceName": {
            "description": "ReferenceName represents a BHL entity that includes a matched scientific name and the reference where this name was discovered.",
            "type": "object",
            "properties": {
                "name": {
                ...
                "refMatchQuality": {
                    "description": "RefMatchQuality provides a number between 0 and 5 to indicate if\nthe reference is a good match for the input.\n1 - nothing is found\n2 - 15% (Odds \u003e 0.01)\n3 - 50% (Odds \u003e 0.1)\n4 - 80% (Odds \u003e 1)\n5 - 98% (Odds \u003e 10)",
                    "type": "integer"
                },
                "reference": {
        ...
        "input.Name": {
            ...
            "properties": {
                ...
                "canonical": {
                    "description": "CanonicalSimple is the canonical form of a name, meaning the name without\nauthorship or a year.",
                    "type": "string",
                    "example": "Canis lupus"
                },
                "canonicalStem": {
                    "description": "CanonicalStem is the canonical form further normalized by removing\nsuffixes of specific and infraspecific epithets as well as normalizing\nsome interchangeable letters.",
                    "type": "string",
                    "example": "Canis lup"
                },
                "nameString": {
        ...
        "input.Params": {
            ...
            "properties": {
                "nomenEvent": {
                    "description": "WithNomenEvent is true when the result tries to get a nomenclatural event\nfor the name.",
                    "type": "boolean",
                    "example": false
                },
                "refsLimit": {
                    "description": "RefsLimit provides the maximum number of references to return for each\nname.",
                    "type": "integer",
                    "example": 3
                },
                "shortenedOutput": {
                    "description": "WithShortenedOutput determines if references details will be provided.\nIf it is ` + "`" + `true` + "`" + `, found references are not provided, only the metadata\nabout them.",
                    "type": "boolean",
                    "example": false
                },
                "showDetails": {
                    "description": "WithDetails is true when it is desirable to show more information in the\noutput.",
                    "type": "boolean",
                    "example": false
                },
                "sortDesc": {
                    "description": "SortDesc determines the order of sorting the output data. If ` + "`" + `true` + "`" + `\ndata are sorted by year from latest to earliest. If ` + "`" + `false` + "`" + ` then from\nearliest to latest.",
                    "type": "boolean",
                    "example": true
                },
                "taxon": {
                    "description": "WithTaxon is true when result includes data from all names that point to\na particular taxon, not only from the given name.",
                    "type": "boolean",
                    "example": false
                }
            }
